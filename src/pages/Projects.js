...
const Projects = () =>{
    return (
        <div className="container">
            <h1>Projects</h1>
            <div>
                <img src={`${process.env.PUBLIC_URL}/project1.png`} alt="Project 1" style={{width: '500px', height: 'auto'}} />
            ...
            <div>
                <img src={`${process.env.PUBLIC_URL}/project2.jpg`} alt="Project 2" style={{width: '500px', height: 'auto'}} />
            ...
            <div>
                <img src={`${process.env.PUBLIC_URL}/project3.png`} alt="Project 3" style={{width: '500px', height: 'auto'}} />
